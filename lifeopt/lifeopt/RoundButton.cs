...
namespace AdvButton
{
    ...
    public class RoundButton : Button
    {
        ...
        private void InitializeComponent()
        {
            ...
            // RoundButton
            // 
            this.ForeColorChanged += this.RoundButton_ForeColorChanged;
            this.Enter += this.RoundButton_Enter;
            this.MouseEnter += this.RoundButton_MouseEnter;
            this.BackColorChanged += this.RoundButton_BackColorChanged;
            this.Leave += this.RoundButton_Leave;
            this.MouseLeave += this.RoundButton_MouseLeave;
